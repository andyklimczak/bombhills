...
10.times do |i|
  User.first.locations.create({title: "location title #{i}", description: "location description #{i}", latitude: Random.rand(27..49), longitude: Random.rand(-123..-76), difficulty: ['Beginner', 'Intermediate', 'Expert'].sample})
end
