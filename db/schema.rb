...
ActiveRecord::Schema.define(version: 20170402030252) do
  ...
  create_table "meetup_attendees", id: :serial, force: :cascade do |t|
    t.integer "user_id"
    t.integer "meetup_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["meetup_id"], name: "index_meetup_attendees_on_meetup_id"
    t.index ["user_id"], name: "index_meetup_attendees_on_user_id"
  end
  ...
  create_table "meetups", id: :serial, force: :cascade do |t|
    ...
    t.index ["spot_id"], name: "index_meetups_on_spot_id"
  end
