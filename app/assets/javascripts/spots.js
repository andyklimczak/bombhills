  ...
  $.ajax({
    ...
    response.spots.forEach(function(spot) {
      L.marker([spot.latitude, spot.longitude], { clickable: true })
        .bindPopup("<b>" + spot.title + "</b></br>Description: " + spot.description + "<br>Created by: " + spot.user.username + "<br>Difficulty: " + spot.difficulty + "<br>Traffic: " + spot.traffic + "<br><a href='/spots/" + spot.id + "/meetups/new'>meetup</a>" +"<br><a data-toggle='modal' data-target='#reportModal'>report</a>")
        .addTo(mymap);
    });
  }).fail(function() {
