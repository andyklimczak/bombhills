  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved meetup as @meetup" do
        post :create, {:meetup => invalid_attributes}, valid_session
        expect(assigns(:meetup)).to be_a_new(Meetup)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested meetup" do
        meetup = Meetup.create! valid_attributes
        put :update, {:id => meetup.to_param, :meetup => new_attributes}, valid_session
        meetup.reload
    ...
    context "with invalid params" do
      it "assigns the meetup as @meetup" do
        meetup = Meetup.create! valid_attributes
        put :update, {:id => meetup.to_param, :meetup => invalid_attributes}, valid_session
        expect(assigns(:meetup)).to eq(meetup)
      end
